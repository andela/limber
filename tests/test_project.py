...
class TestProject(TestCase):
	...
	def setUp(self):
		...
		self.project = Project.create_project(owner=self.owner, project_name=self.project_name,
	...
	def test_add_new_project_succeeds_when_enter_different_data(self):
		self.project_name = fake.first_name()
		self.project_desc = fake.sentence()
		project = Project.create_project(owner=self.owner, project_name=self.project_name,
			project_desc=self.project_desc)
