...
class ProjectSerializer(serializers.ModelSerializer):
    # Add stories hyperliink to serializer 
    stories = serializers.HyperlinkedRelatedField(many=True, read_only=True,view_name='story-detail')
    ...
    class Meta:
        model = Project
        fields = ('url', 'owner', 'project_name', 'project_desc', 'team_members','stories')
        validators = [
